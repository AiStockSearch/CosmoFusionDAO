...
{
  return (
    <div className="flex flex-col gap-2 mb-6 md:w-[22rem]">
      <h4 className="font-space-mono text-lg font-semibold" style={{ color: 'var(--color-text-gray-900)' }}>
      ...
      <div className="flex space-x-2 mb-2 rounded-xl relative" style={{ background: 'var(--color-bg-gray-100)' }}>
        <input
          ...
          className="flex-1 px-4 py-3 rounded-xl focus:outline-none focus:border-transparent font-space-mono" style={{ background: 'var(--color-bg-gray-100)' }} />
      ...
      <p className="font-space-mono text-sm mb-0 leading-[0.8]" style={{ color: 'var(--color-text-gray-400)' }}>
