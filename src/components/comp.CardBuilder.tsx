        ...
        <div className="mt-3 flex flex-row flex-wrap items-start justify-start">
          {cardBuilder?.map( ( x: any, index: number ) => (
            <div
              ...
              tabIndex={index}
              key={index}
              className="flex flex-row items-start justify-start cursor-pointer outline-none focus:outline-none"
            >
              <span
                className={[
                  'jobs-header-desc leading-relaxed mb-0 mr-4 hover:scale-105 transition-all duration-300 cursor-pointer hover:text-cyan-700 outline-none focus:outline-none',
